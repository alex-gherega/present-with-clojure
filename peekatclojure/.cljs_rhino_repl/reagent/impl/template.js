...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17970__auto__,writer__17971__auto__,opt__17972__auto__){
return cljs.core._write.call(null,writer__17971__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__19386 = o;
(G__19386[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__19387__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__19387 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__19388__i = 0, G__19388__a = new Array(arguments.length -  0);
while (G__19388__i < G__19388__a.length) {G__19388__a[G__19388__i] = arguments[G__19388__i + 0]; ++G__19388__i;}
  args = new cljs.core.IndexedSeq(G__19388__a,0);
} 
...
var args = cljs.core.seq(arglist__19389);
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,rendered_value,dom_value,node,temp__4429__auto__){
return (function (){
...
if(cljs.core.truth_((function (){var and__17360__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__17360__auto__){
var and__17360__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__17360__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__17360__auto____$1;
}
} else {
...
var G__19395 = jsprops;
(G__19395["defaultValue"] = value);

(G__19395["onChange"] = ((function (G__19395,v,value,on_change){
return (function (p1__19392_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__19392_SHARP_);
});})(G__19395,v,value,on_change))
);

(G__19395["ref"] = ((function (G__19395,v,value,on_change){
return (function (p1__19393_SHARP_){
return (this$["cljsInputElement"] = p1__19393_SHARP_);
});})(G__19395,v,value,on_change))
);
...
var vec__19400 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__19400,(0),null);
var id = cljs.core.nth.call(null,vec__19400,(1),null);
var class$ = cljs.core.nth.call(null,vec__19400,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___19403 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___19403 == null)){
} else {
var key_19404 = temp__4429__auto___19403;
(jsprops["key"] = key_19404);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__19406 = (new reagent.impl.template.NativeWrapper());
(G__19406["name"] = c);
...
var len__18430__auto___19412 = arguments.length;
var i__18431__auto___19413 = (0);
while(true){
if((i__18431__auto___19413 < len__18430__auto___19412)){
args__18437__auto__.push((arguments[i__18431__auto___19413]));

var G__19414 = (i__18431__auto___19413 + (1));
i__18431__auto___19413 = G__19414;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__18438__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq19410){
var G__19411 = cljs.core.first.call(null,seq19410);
var seq19410__$1 = cljs.core.next.call(null,seq19410);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__19411,seq19410__$1);
});
...
break;
default:
var G__19418 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__19418;
continue;
...
var n__18275__auto___19421 = a.length;
var i_19422 = (0);
while(true){
if((i_19422 < n__18275__auto___19421)){
(a[i_19422] = reagent.impl.template.as_element.call(null,(a[i_19422])));

var G__19423 = (i_19422 + (1));
i_19422 = G__19423;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__18275__auto___19424 = a.length;
var i_19425 = (0);
while(true){
if((i_19425 < n__18275__auto___19424)){
var val_19426 = (a[i_19425]);
if((cljs.core.vector_QMARK_.call(null,val_19426)) && ((reagent.impl.template.key_from_vec.call(null,val_19426) == null))){
(o["no-key"] = true);
} else {
}

(a[i_19425] = reagent.impl.template.as_element.call(null,val_19426));

var G__19427 = (i_19425 + (1));
i_19425 = G__19427;
continue;
} else {
}
...
var ctx = {};
var vec__19429 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__19429,(0),null);
var derefed = cljs.core.nth.call(null,vec__19429,(1),null);
...
var G__19431 = (cljs.core.count.call(null,argv) - first_child);
switch (G__19431) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__19431){
