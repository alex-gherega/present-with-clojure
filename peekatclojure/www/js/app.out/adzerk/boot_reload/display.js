...
var attr = cljs.core.nth.call(null,vec__8589,(0),null);
var v = cljs.core.nth.call(null,vec__8589,(1),null);
...
var args8590 = [];
var len__7513__auto___8593 = arguments.length;
var i__7514__auto___8594 = (0);
while(true){
if((i__7514__auto___8594 < len__7513__auto___8593)){
args8590.push((arguments[i__7514__auto___8594]));

var G__8595 = (i__7514__auto___8594 + (1));
i__7514__auto___8594 = G__8595;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args8590.length)].join('')));
...
var len__7513__auto___8598 = arguments.length;
var i__7514__auto___8599 = (0);
while(true){
if((i__7514__auto___8599 < len__7513__auto___8598)){
args__7520__auto__.push((arguments[i__7514__auto___8599]));

var G__8600 = (i__7514__auto___8599 + (1));
i__7514__auto___8599 = G__8600;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8597){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8597));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8601){
var map__8605 = p__8601;
...
var data = map__8605__$1;
var message = cljs.core.get.call(null,map__8605__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8605__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8605__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8607 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8607,goog.events.EventType.CLICK,((function (G__8607,map__8605,map__8605__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8607,map__8605,map__8605__$1,data,message,line,file))
);

return G__8607;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8608){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8615){
var map__8619 = p__8615;
var map__8619__$1 = ((((!((map__8619 == null)))?((((map__8619.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8619.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8619):map__8619);
var messages = map__8619__$1;
var warnings = cljs.core.get.call(null,map__8619__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8619__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8621 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8621,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8621,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8622){
var map__8625 = p__8622;
...
var messages = map__8625__$1;
var warnings = cljs.core.get.call(null,map__8625__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8625__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8625,map__8625__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8625,map__8625__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8625,map__8625__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8625,map__8625__$1,messages,warnings,exception))
;
