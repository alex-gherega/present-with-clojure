...
return m__7111__auto__.call(null,this$,request,handler);
} else {
var m__7111__auto____$1 = (ajax.protocols._js_ajax_request["_"]);
if(!((m__7111__auto____$1 == null))){
return m__7111__auto____$1.call(null,this$,request,handler);
} else {
...
if(!((m__7111__auto__ == null))){
return m__7111__auto__.call(null,this$,header);
} else {
var m__7111__auto____$1 = (ajax.protocols._get_response_header["_"]);
if(!((m__7111__auto____$1 == null))){
return m__7111__auto____$1.call(null,this$,header);
} else {
...
if(!((m__7111__auto__ == null))){
return m__7111__auto__.call(null,this$,request);
} else {
var m__7111__auto____$1 = (ajax.protocols._process_request["_"]);
if(!((m__7111__auto____$1 == null))){
return m__7111__auto____$1.call(null,this$,request);
} else {
...
if(!((m__7111__auto__ == null))){
return m__7111__auto__.call(null,this$,response);
} else {
var m__7111__auto____$1 = (ajax.protocols._process_response["_"]);
if(!((m__7111__auto____$1 == null))){
return m__7111__auto____$1.call(null,this$,response);
} else {
...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__7071__auto__,k7566,else__7072__auto__){
var self__ = this;
var this__7071__auto____$1 = this;
var G__7568 = (((k7566 instanceof cljs.core.Keyword))?k7566.fqn:null);
switch (G__7568) {
case "status":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k7566,else__7072__auto__);
...
;
return cljs.core.pr_sequential_writer.call(null,writer__7084__auto__,pr_pair__7086__auto__,"#ajax.protocols.Response{",", ","}",opts__7085__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"status","status",-1997798413),self__.status],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"body","body",-2049205669),self__.body],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"status-text","status-text",-1834235478),self__.status_text],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"headers","headers",-835030129),self__.headers],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),self__.was_aborted],null))], null),self__.__extmap));
});

ajax.protocols.Response.prototype.cljs$core$IIterable$ = true;

ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__7565){
var self__ = this;
var G__7565__$1 = this;
return (new cljs.core.RecordIter((0),G__7565__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__7079__auto__)),null));
}
});

ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__7076__auto__,k__7077__auto__,G__7565){
var self__ = this;
var this__7076__auto____$1 = this;
var pred__7569 = cljs.core.keyword_identical_QMARK_;
var expr__7570 = k__7077__auto__;
if(cljs.core.truth_(pred__7569.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__7570))){
return (new ajax.protocols.Response(G__7565,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7569.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__7570))){
return (new ajax.protocols.Response(self__.status,G__7565,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7569.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__7570))){
return (new ajax.protocols.Response(self__.status,self__.body,G__7565,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7569.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__7570))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__7565,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__7569.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__7570))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__7565,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__7077__auto__,G__7565),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__7068__auto__,G__7565){
var self__ = this;
var this__7068__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__7565,self__.__extmap,self__.__hash));
});
...
return cljs.core._write.call(null,writer__7104__auto__,"ajax.protocols/Response");
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__7567){
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__7567),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__7567),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__7567),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__7567),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__7567),null,cljs.core.dissoc.call(null,G__7567,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)),null));
});
