...
weasel.repl.repl_print.cljs$lang$applyTo = (function (seq9981){
return weasel.repl.repl_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9981));
});
weasel.repl.console_print = (function weasel$repl$console_print(var_args){
var args__7520__auto__ = [];
var len__7513__auto___9986 = arguments.length;
var i__7514__auto___9987 = (0);
while(true){
if((i__7514__auto___9987 < len__7513__auto___9986)){
args__7520__auto__.push((arguments[i__7514__auto___9987]));

var G__9988 = (i__7514__auto___9987 + (1));
i__7514__auto___9987 = G__9988;
continue;
} else {
}
break;
...
weasel.repl.console_print.cljs$lang$applyTo = (function (seq9985){
return weasel.repl.console_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9985));
});
...
weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic = (function (repl_server_url,p__9994){
var map__9995 = p__9994;
var map__9995__$1 = ((((!((map__9995 == null)))?((((map__9995.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9995.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9995):map__9995);
var verbose = cljs.core.get.call(null,map__9995__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var on_open = cljs.core.get.call(null,map__9995__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var on_error = cljs.core.get.call(null,map__9995__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_close = cljs.core.get.call(null,map__9995__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var print = cljs.core.get.call(null,map__9995__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__9995,map__9995__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
});})(repl_connection,map__9995,map__9995__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__9995,map__9995__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
var map__9997 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__9997__$1;
var op = cljs.core.get.call(null,map__9997__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__9995,map__9995__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__9995,map__9995__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__9995,map__9995__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
weasel.repl.connect.cljs$lang$applyTo = (function (seq9992){
var G__9993 = cljs.core.first.call(null,seq9992);
var seq9992__$1 = cljs.core.next.call(null,seq9992);
return weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic(G__9993,seq9992__$1);
});
