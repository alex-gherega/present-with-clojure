...
return cljs.core._write.call(null,writer__7054__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__8931 = o;
(G__8931[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__6443__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__6443__auto__){
var and__6443__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__8940 = jsprops;
(G__8940["defaultValue"] = value);

(G__8940["onChange"] = ((function (G__8940,v,value,on_change){
return (function (p1__8937_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__8937_SHARP_);
});})(G__8940,v,value,on_change))
);

(G__8940["ref"] = ((function (G__8940,v,value,on_change){
return (function (p1__8938_SHARP_){
return (this$["cljsInputElement"] = p1__8938_SHARP_);
});})(G__8940,v,value,on_change))
);
...
var vec__8945 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__8945,(0),null);
var id = cljs.core.nth.call(null,vec__8945,(1),null);
var class$ = cljs.core.nth.call(null,vec__8945,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___8948 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___8948 == null)){
} else {
var key_8949 = temp__4429__auto___8948;
(jsprops["key"] = key_8949);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__8951 = (new reagent.impl.template.NativeWrapper());
(G__8951["name"] = c);
...
args__7520__auto__.push((arguments[i__7514__auto___8958]));
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq8955){
var G__8956 = cljs.core.first.call(null,seq8955);
var seq8955__$1 = cljs.core.next.call(null,seq8955);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__8956,seq8955__$1);
});
...
break;
default:
var G__8963 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__8963;
continue;
...
var n__7358__auto___8966 = a.length;
var i_8967 = (0);
while(true){
if((i_8967 < n__7358__auto___8966)){
(a[i_8967] = reagent.impl.template.as_element.call(null,(a[i_8967])));
...
var a = cljs.core.into_array.call(null,s);
var n__7358__auto___8969 = a.length;
var i_8970 = (0);
while(true){
if((i_8970 < n__7358__auto___8969)){
var val_8971 = (a[i_8970]);
if((cljs.core.vector_QMARK_.call(null,val_8971)) && ((reagent.impl.template.key_from_vec.call(null,val_8971) == null))){
(o["no-key"] = true);
} else {
}

(a[i_8970] = reagent.impl.template.as_element.call(null,val_8971));

var G__8972 = (i_8970 + (1));
i_8970 = G__8972;
continue;
} else {
}
...
var ctx = {};
var vec__8974 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__8974,(0),null);
var derefed = cljs.core.nth.call(null,vec__8974,(1),null);
...
var G__8976 = (cljs.core.count.call(null,argv) - first_child);
switch (G__8976) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__8976){
